  ...
  try:
    ...
    if response.generated_images and len(response.generated_images) > 0:
      ...
      if image and image.image_bytes:
        ...
        # Handle case where SDK returns base64-encoded string instead of raw bytes
        if image_bytes[:4] == b"iVBO":  # Base64-encoded PNG signature
          logger.info("Detected base64-encoded image, decoding...")
