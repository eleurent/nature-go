...
BADGE_LOGICS = {
    ...
    "Waterfowl Whisperer": SpeciesBadgeLogic(
        ...
        species_list=["Dendrocygna viduata", "Dendrocygna bicolor", "Anser indicus", "Anser caerulescens",
                     ...
                     "Branta hutchinsii", "Branta canadensis", "Branta ruficollis", "Cygnus olor",
                     "Cygnus columbianus", "Cygnus cygnus", "Alopochen aegyptiaca", "Tadorna ferruginea",
                     "Tadorna tadorna", "Aix sponsa", "Aix galericulata", "Sibirionetta formosa", "Spatula querquedula",
                     "Spatula discors", "Spatula clypeata", "Mareca strepera", "Mareca falcata", "Mareca penelope",
                     "Mareca americana", "Anas zonorhyncha", "Anas platyrhynchos", "Anas rubripes",
                     "Anas acuta", "Anas crecca", "Marmaronetta angustirostris", "Netta rufina", "Aythya valisineria",
                     "Aythya americana", "Aythya ferina", "Aythya collaris", "Aythya nyroca", "Aythya fuligula",
                     "Aythya marila", "Aythya affinis", "Polysticta stelleri", "Somateria fischeri",
                     "Somateria spectabilis", "Somateria mollissima", "Histrionicus histrionicus", "Melanitta perspicillata",
                     "Melanitta fusca", "Melanitta deglandi", "Melanitta stejnegeri", "Melanitta nigra",
                     "Melanitta americana", "Clangula hyemalis", "Bucephala albeola", "Bucephala clangula",
                     "Bucephala islandica", "Mergellus albellus", "Lophodytes cucullatus", "Mergus merganser",
                     "Mergus serrator", "Oxyura jamaicensis", "Oxyura leucocephala"],
        common_species_list=["Anser anser", "Anser albifrons", "Branta bernicla", "Branta leucopsis",
                             "Branta canadensis", "Cygnus olor", "Cygnus columbianus", "Tadorna tadorna",
                             "Anas platyrhynchos", "Anas rubripes", "Anas acuta", "Anas crecca", "Aythya ferina",
                             "Aythya fuligula", "Aythya marila", "Clangula hyemalis", "Bucephala clangula",
                             "Mergus merganser", "Mergus serrator", "Oxyura leucocephala"]
    ),
    "Duck Dynasty": SpeciesBadgeLogic(
        "Duck Dynasty", "Observe different duck species.",
        levels={"Bronze": 3, "Silver": 6, "Gold": 9},
        species_list=["Aix sponsa", "Aix galericulata", "Sibirionetta formosa", "Spatula querquedula",
                     "Spatula discors", "Spatula clypeata", "Mareca strepera", "Mareca falcata", "Mareca penelope",
                     "Mareca americana", "Anas zonorhyncha", "Anas platyrhynchos", "Anas rubripes",
                     "Anas acuta", "Anas crecca", "Marmaronetta angustirostris", "Netta rufina", "Aythya valisineria",
                     "Aythya americana", "Aythya ferina", "Aythya collaris", "Aythya nyroca", "Aythya fuligula",
                     ...
                     "Bucephala islandica", "Mergellus albellus", "Lophodytes cucullatus", "Mergus merganser",
                     "Mergus serrator", "Oxyura jamaicensis", "Oxyura leucocephala"],
        common_species_list=["Anas platyrhynchos", "Anas rubripes", "Anas acuta", "Anas crecca", "Aythya ferina",
                             "Aythya fuligula", "Aythya marila", "Clangula hyemalis", "Bucephala clangula",
                             "Mergus merganser", "Mergus serrator", "Oxyura leucocephala"]
    ),
    "Baryard Birder": SpeciesBadgeLogic(
        "Baryard Birder", "Observe different birds commonly found in barnyards.",
        levels={"Bronze": 3, "Silver": 5, "Gold": 7},
        species_list=["Anser anser", "Anser albifrons", "Branta canadensis", "Alopochen aegyptiaca",
                     "Tadorna tadorna", "Columba livia", "Streptopelia turtur", "Streptopelia decaocto",
                     "Coturnix coturnix", "Alectoris rufa", "Phasianus colchicus", "Perdix perdix",
                     "Gallinula chloropus", "Fulica atra", "Bubulcus ibis", "Ciconia ciconia", "Ardea cinerea",
                     "Pica pica", "Corvus corone", "Corvus cornix", "Corvus monedula", "Corvus frugilegus",
                     "Passer domesticus", "Passer montanus", "Petronia petronia", "Motacilla alba", "Motacilla flava",
                     "Alauda arvensis", "Galerida cristata", "Erithacus rubecula", "Turdus merula", "Turdus philomelos",
                     "Turdus iliacus", "Turdus viscivorus", "Fringilla coelebs", "Carduelis carduelis", "Chloris chloris",
                     "Linaria cannabina", "Emberiza citrinella", "Emberiza calandra"],
        common_species_list=["Anser anser", "Branta canadensis", "Tadorna tadorna", "Columba livia", "Streptopelia turtur",
                             "Streptopelia decaocto", "Coturnix coturnix", "Alectoris rufa", "Phasianus colchicus", 
                             "Perdix perdix", "Gallinula chloropus", "Fulica atra", "Bubulcus ibis", "Ciconia ciconia",
                             "Ardea cinerea", "Pica pica", "Corvus corone", "Corvus monedula", "Corvus frugilegus",
                             "Passer domesticus", "Passer montanus", "Motacilla alba", "Alauda arvensis", 
                             "Galerida cristata", "Erithacus rubecula", "Turdus merula", "Turdus philomelos",
                             "Turdus iliacus", "Turdus viscivorus", "Fringilla coelebs", "Carduelis carduelis",
                             "Chloris chloris", "Linaria cannabina", "Emberiza citrinella", "Emberiza calandra"]
    ),
    "Woodland Wanderer": SpeciesBadgeLogic(
        ...
        species_list=["Tetrastes bonasia", "Lagopus lagopus", "Lagopus muta", "Tetrao urogallus", "Lyrurus tetrix",
                     ...
                     "Botaurus stellaris", "Nycticorax nycticorax", "Ardea cinerea", "Ardea purpurea", "Ciconia ciconia",
        ...
        common_species_list=["Columba palumbus", "Cuculus canorus", "Caprimulgus europaeus", "Apus apus", 
                             ...
                             "Botaurus stellaris", "Nycticorax nycticorax", "Ardea cinerea", "Pernis apivorus", "Buteo buteo", 
