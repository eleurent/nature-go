...
BADGE_LOGICS = {
    ...
    "Backyard Birder": SpeciesBadgeLogic(
        ...
        species_list=["Anser anser", "Branta canadensis", "Alopochen aegyptiaca", "Tadorna tadorna",
                     "Columba livia", "Streptopelia turtur", "Streptopelia decaocto", "Coturnix coturnix",
                     "Alectoris rufa", "Phasianus colchicus", "Perdix perdix", "Gallinula chloropus",
                     "Fulica atra", "Bubulcus ibis", "Ciconia ciconia", "Ardea cinerea", "Pica pica",
                     ...
                     "Acanthis flammea", "Loxia curvirostra"],
        common_species_list=["Columba livia", "Streptopelia turtur", "Streptopelia decaocto", 
                             ...
                             "Emberiza cia", "Emberiza schoeniclus", "Sylvia atricapilla", "Sylvia borin", 
                             "Curruca nisoria", "Curruca curruca", "Curruca melanocephala", "Regulus regulus", 
                             "Sitta europaea", "Certhia familiaris", "Troglodytes troglodytes", "Sturnus vulgaris", 
